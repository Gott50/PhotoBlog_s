<?php
/**
 * PhotoBlog_s functions and definitions
 *
...
if ( ! function_exists( 'photoblog_s_setup' ) ) :
	/**
	 ...
	 */
	function photoblog_s_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on PhotoBlog_s, use a find and replace
		 * to change 'photoblog_s' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'photoblog_s', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'photoblog_s_custom_background_args', array(
 ...
 */
function photoblog_s_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'photoblog_s' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'photoblog_s' ),
...
add_action( 'widgets_init', 'photoblog_s_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function photoblog_s_scripts() {
	wp_enqueue_style( 'photoblog_s-style', get_stylesheet_uri() );

	wp_enqueue_script( 'photoblog_s-navigation', get_template_directory_uri() . '/js/comments.js', array(), '20151215', true );
...
add_action( 'wp_enqueue_scripts', 'photoblog_s_scripts' );
